          ...
          <div class="card-body p-lg-5 p-4">
            <div class="section-header text-center mb-5">
              ...
              <h2 class="display-6 fw-bold mb-3">
                <span class="gradient-text">Daftar</span> ke SIKC B 2023
              </h2>
              <div class="section-divider mx-auto"></div>
              <p class="text-secondary lead mt-3">Bergabunglah dengan komunitas mahasiswa SIKC</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="row justify-content-center">
      <div class="col-lg-6 col-md-8">
        <div class="card border-0 shadow-lg rounded-5 overflow-hidden auth-card">
          <div class="card-body p-lg-5 p-4">
            <form method="post" action="<?= url('register') ?>" class="auth-form-modern auth-form" novalidate data-loading-message="Mendaftarkan akun Anda...">
              ...
              <div class="form-floating mb-3">
                <input type="text" 
                       ...
                       minlength="2"
                       maxlength="50"
                       data-error-message="Nama lengkap harus diisi minimal 2 karakter">
                <label for="name"><i class="bi bi-person-fill me-2"></i>Nama Lengkap</label>
                <div class="invalid-feedback">Nama lengkap harus diisi minimal 2 karakter</div>
              </div>
              ...
              <div class="form-floating mb-3">
                <input type="password" 
                       ...
                       minlength="6"
                       maxlength="50"
                       data-error-message="Kata sandi harus minimal 6 karakter">
                <label for="password"><i class="bi bi-lock-fill me-2"></i>Kata Sandi</label>
                <div class="invalid-feedback">Kata sandi harus minimal 6 karakter</div>
              </div>
              ...
              <div class="form-floating mb-4">
                <input type="password" 
                       ...
                       required
                       minlength="6"
                       data-error-message="Konfirmasi kata sandi harus sama dengan kata sandi">
                <label for="password2"><i class="bi bi-lock-fill me-2"></i>Konfirmasi Kata Sandi</label>
                <div class="invalid-feedback">Konfirmasi kata sandi harus sama dengan kata sandi</div>
              </div>
...
<script>
// ✅ Modern Form Validation with Indonesian Messages for Register Form
document.addEventListener('DOMContentLoaded', function() {
    ...
    const errorMessages = {
        name: 'Nama lengkap harus diisi minimal 2 karakter',
        email: 'Silakan masukkan alamat email yang valid',
        password: 'Kata sandi harus minimal 6 karakter',
        password2: 'Konfirmasi kata sandi harus sama dengan kata sandi'
    };
    ...
    form.addEventListener('submit', function(e) {
        ...
        if (isFormValid) {
            ...
            if (window.preloader) {
                window.preloader.show('Mendaftarkan akun Anda...');
            }
